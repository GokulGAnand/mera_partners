class Constants {
  ...
  static const List<String> rcAvailabilityList = [
    'Original',
    'Photocopy',
    'Duplicate',
    'Lost',
  ...
  static const List<String> ccClassList = [
    'Less than 1.5L',
    'More than 1.5L',
  ];
  static const List<String> lengthList = [
    'Less than 4M',
    'More than 4M',
  ];
  static const List<String> vehicleUsageList = [
    'Motor Cab(Taxi)',
    'Motor Car(Private)',
  ];
  ...
  static const List<String> transmissionList = [
    'Manual',
    'Automatic',
  ];
  ...
  static const List<String> steeringSystemList = ['Electric', 'Hydraulic'];
