  ...
  try {
    ...
    if(response.statusCode == 200){
      ...
      if (reportResponse.value.data != null) {
        ...
        features.value = [
          Master(title: MyStrings.keyLessEntry, value: reportResponse.value.data!.allCarInfo!.keylessEntry.toString() ?? ''),
          ...
          Master(title: MyStrings.sunroof, value: reportResponse.value.data!.allCarInfo!.sunroof.toString() ?? ''),
          Master(title: MyStrings.gpsNavigation, value: reportResponse.value.data!.allCarInfo!.gpsNavigation ?? ''),
          Master(title: MyStrings.alloyWheels, value: reportResponse.value.data!.allCarInfo!.alloyWheels.toString() ?? ''),
          Master(title: MyStrings.airBag, value: reportResponse.value.data!.allCarInfo!.airbag.toString() ?? ''),
          Master(title: MyStrings.seatBelt, value: reportResponse.value.data!.allCarInfo!.seatBelt ?? ''),
          Master(title: MyStrings.absEbd, value: reportResponse.value.data!.allCarInfo!.absEbd.toString() ?? ''),
          Master(title: MyStrings.gloveBox, value: reportResponse.value.data!.allCarInfo!.gloveBox.toString() ?? ''),
          Master(title: MyStrings.interiorModifications, value: reportResponse.value.data!.allCarInfo!.interiorView.toString() ?? ''),
        ];
        testDrive.value = [
          Master(title: MyStrings.steering, value: reportResponse.value.data!.allCarInfo!.steeringSystem ?? ''),
          Master(title: MyStrings.steeringWheel, value: reportResponse.value.data!.allCarInfo!.steeringWheel.toString() ?? ''),
          ...
          Master(title: MyStrings.suspensionSystem, value: reportResponse.value.data!.allCarInfo!.suspension.toString() ?? ''),
          ...
          Master(title: MyStrings.transmissionAutomatic, value: reportResponse.value.data!.allCarInfo!.transmissionAutomatic.toString() ?? ''),
          Master(title: MyStrings.vehicleHorn, value: reportResponse.value.data!.allCarInfo!.vehicleHorn.toString() ?? ''),
        ];
        engine.value = [
          Master(title: MyStrings.engineSound, value: reportResponse.value.data!.allCarInfo!.engineSound ?? ''),
          Master(title: MyStrings.engine, value: reportResponse.value.data!.allCarInfo!.engineCondition.toString() ?? ''),
          Master(title: MyStrings.smoke, value: reportResponse.value.data!.allCarInfo!.exhaustSmoke ?? ''),
          Master(title: MyStrings.battery, value: reportResponse.value.data!.allCarInfo!.battery.toString() ?? ''),
          ...
          Master(title: MyStrings.blowByBackCompression, value: reportResponse.value.data!.allCarInfo!.blowBy.toString() ?? ''),
          Master(title: MyStrings.silencer, value: reportResponse.value.data!.allCarInfo!.silencer ?? ''),
          Master(title: MyStrings.clutchOperations, value: reportResponse.value.data!.allCarInfo!.clutch.toString() ?? ''),
          Master(title: MyStrings.gearbox, value: reportResponse.value.data!.allCarInfo!.gearBox.toString() ?? ''),
          Master(title: MyStrings.engineOil, value: reportResponse.value.data!.allCarInfo!.engineOil.toString() ?? ''),
          Master(title: MyStrings.turboCharger, value: reportResponse.value.data!.allCarInfo!.turboCharger.toString() ?? ''),
          Master(title: MyStrings.gearboxLeakage, value: reportResponse.value.data!.allCarInfo!.gearBoxLeakage ?? ''),
          Master(title: MyStrings.engineMount, value: reportResponse.value.data!.allCarInfo!.mount.toString() ?? ''),
          Master(title: MyStrings.sump, value: reportResponse.value.data!.allCarInfo!.sump.toString() ?? ''),
          Master(title: MyStrings.comments, value: reportResponse.value.data!.allCarInfo!.engineComment ?? ''),
        ];
        interiorAndElectrical.value = [
          Master(title: MyStrings.clusterPanel, value: reportResponse.value.data!.allCarInfo!.clusterPanel.toString() ?? ''),
          ...
          Master(title: MyStrings.insideRearViewMirror, value: reportResponse.value.data!.allCarInfo?.interiorView.toString() ?? ''),
          ...
          Master(title: MyStrings.powerWindowAndWindowLock, value: reportResponse.value.data!.allCarInfo!.powerWindowCentalLock.toString() ?? ''),
          Master(title: MyStrings.handBrake, value: reportResponse.value.data!.allCarInfo!.handBreak.toString() ?? ''),
          Master(title: MyStrings.carElectrical, value: reportResponse.value.data!.allCarInfo!.carElectrical.toString() ?? ''),
          Master(title: MyStrings.secondKey, value: reportResponse.value.data!.allCarInfo!.secondKey ?? ''),
          Master(title: MyStrings.platform, value: reportResponse.value.data!.allCarInfo!.platform.toString() ?? ''),
        ];
        airCondition.value = [
          Master(title: MyStrings.acWorking, value: reportResponse.value.data!.allCarInfo!.acWorking ?? ''),
          Master(title: MyStrings.cooling, value: reportResponse.value.data!.allCarInfo!.airCooling.toString() ?? ''),
          ...
          Master(title: MyStrings.acCondenserCompressor, value: reportResponse.value.data!.allCarInfo!.acCondensor.toString() ?? ''),
        ...
        exterior.value = [
          Master(title: MyStrings.frontImage, value: reportResponse.value.data!.front?.remarks ?? ''),
          Master(title: MyStrings.frontLeftImage, value: reportResponse.value.data!.frontLeft?.remarks ?? ''),
          Master(title: MyStrings.frontRightImage, value: reportResponse.value.data!.frontRight?.remarks ?? ''),
          ...
          Master(title: MyStrings.rearLeftImage, value: reportResponse.value.data!.rearLeft?.remarks ?? ''),
          Master(title: MyStrings.rearImage, value: reportResponse.value.data!.rear?.remarks ?? ''),
          Master(title: MyStrings.rearRight, value: reportResponse.value.data!.rearRight?.remarks ?? ''),
          ...
          // Master(title: MyStrings.cowlTop, value: reportResponse.value.data!.allCarInfo?.?.remarks ?? ''),
