    ...
    if(response.statusCode == 200){
      ...
      if (reportResponse.value.data != null) {
        ...
        engine.value = [
          ...
          Master(title: MyStrings.battery, value: reportResponse.value.data!.allCarInfo!.battery?.join(',') ?? ''),
          ...
          Master(title: MyStrings.blowByBackCompression, value: reportResponse.value.data!.allCarInfo!.blowBy?.join(',') ?? ''),
          Master(title: MyStrings.silencer, value: reportResponse.value.data!.allCarInfo!.silencer ?? ''),
          Master(title: MyStrings.clutchOperations, value: reportResponse.value.data!.allCarInfo!.clutch?.join(',') ?? ''),
          Master(title: MyStrings.gearbox, value: reportResponse.value.data!.allCarInfo!.gearBox?.join(',') ?? ''),
          Master(title: MyStrings.engineOil, value: reportResponse.value.data!.allCarInfo!.engineOil?.join(',') ?? ''),
          Master(title: MyStrings.turboCharger, value: reportResponse.value.data!.allCarInfo!.turboCharger?.join(',') ?? ''),
          Master(title: MyStrings.gearboxLeakage, value: reportResponse.value.data!.allCarInfo!.gearBoxLeakage ?? ''),
          Master(title: MyStrings.engineMount, value: reportResponse.value.data!.allCarInfo!.mount?.join(',') ?? ''),
          Master(title: MyStrings.sump, value: reportResponse.value.data!.allCarInfo!.sump?.join(',') ?? ''),
