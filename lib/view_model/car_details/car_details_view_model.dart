  ...
  void separateListData() {
   ...
   void addImageList() {
    exteriorImages.value = [
      ...
      if(reportResponse.value.data!.allCarInfo!.frontWindShield != null) Master(title: MyStrings.frontWindShieldWiper, image: reportResponse.value.data!.allCarInfo!.frontWindShield?.url),
      if(reportResponse.value.data!.allCarInfo!.rearWindShield != null) Master(title: MyStrings.rearWindShield, image: reportResponse.value.data!.allCarInfo!.rearWindShield?.url),
      if(reportResponse.value.data!.allCarInfo!.doorGlassLeft != null) Master(title: MyStrings.doorGlassLH, image: reportResponse.value.data!.allCarInfo!.doorGlassLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.doorGlassRight != null) Master(title: MyStrings.doorGlassRH, image: reportResponse.value.data!.allCarInfo!.doorGlassRight?.url),
      if(reportResponse.value.data!.allCarInfo!.quarterGlass != null) Master(title: MyStrings.quarterGlass, image: reportResponse.value.data!.allCarInfo!.quarterGlass?.url),
      if(reportResponse.value.data!.allCarInfo!.headLightLeft != null) Master(title: MyStrings.headlightsLH, image: reportResponse.value.data!.allCarInfo!.headLightLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.headLightRight != null) Master(title: MyStrings.headlightsRH, image: reportResponse.value.data!.allCarInfo!.headLightRight?.url),
      if(reportResponse.value.data!.allCarInfo!.headLightSupport != null) Master(title: MyStrings.headlightSupport, image: reportResponse.value.data!.allCarInfo!.headLightSupport?.url),
      if(reportResponse.value.data!.allCarInfo!.grill != null) Master(title: MyStrings.frontGrill, image: reportResponse.value.data!.allCarInfo!.grill?.url),
      if(reportResponse.value.data!.allCarInfo!.bonnetPatti != null) Master(title: MyStrings.bonnetPatti, image: reportResponse.value.data!.allCarInfo!.bonnetPatti?.url),
      if(reportResponse.value.data!.allCarInfo!.upperCrossMember != null) Master(title: MyStrings.upperCrossMember, image: reportResponse.value.data!.allCarInfo!.upperCrossMember?.url),
      if(reportResponse.value.data!.allCarInfo!.lowerCrossMember != null) Master(title: MyStrings.lowerCrossMember, image: reportResponse.value.data!.allCarInfo!.lowerCrossMember?.url),
      if(reportResponse.value.data!.allCarInfo!.cowlTop != null) Master(title: MyStrings.cowlTop, image: reportResponse.value.data!.allCarInfo!.cowlTop?.url),
      if(reportResponse.value.data!.allCarInfo!.chassisExtension != null) Master(title: MyStrings.chassisExtension, image: reportResponse.value.data!.allCarInfo!.chassisExtension?.url),
      if(reportResponse.value.data!.allCarInfo!.fenderLeft != null) Master(title: MyStrings.lhFender, image: reportResponse.value.data!.allCarInfo!.fenderLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.fenderRight != null) Master(title: MyStrings.rhFender, image: reportResponse.value.data!.allCarInfo!.fenderRight?.url),
      if(reportResponse.value.data!.allCarInfo!.quarterPanelLeft != null) Master(title: MyStrings.lhQuarterPanel, image: reportResponse.value.data!.allCarInfo!.quarterPanelLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.quarterPanelRight != null) Master(title: MyStrings.rhQuarterPanel, image: reportResponse.value.data!.allCarInfo!.quarterPanelRight?.url),
      if(reportResponse.value.data!.allCarInfo!.leftApillar != null) Master(title: MyStrings.lhaPillar, image: reportResponse.value.data!.allCarInfo!.leftApillar?.url),
      if(reportResponse.value.data!.allCarInfo!.rightApillar != null) Master(title: MyStrings.rhaPillar, image: reportResponse.value.data!.allCarInfo!.rightApillar?.url),
      if(reportResponse.value.data!.allCarInfo!.leftBpillar != null) Master(title: MyStrings.lhbPillar, image: reportResponse.value.data!.allCarInfo!.leftBpillar?.url),
      if(reportResponse.value.data!.allCarInfo!.rightBpillar != null) Master(title: MyStrings.rhbPillar, image: reportResponse.value.data!.allCarInfo!.rightBpillar?.url),
      if(reportResponse.value.data!.allCarInfo!.leftCpillar != null) Master(title: MyStrings.lhcPillar, image: reportResponse.value.data!.allCarInfo!.leftCpillar?.url),
      if(reportResponse.value.data!.allCarInfo!.rightCpillar != null) Master(title: MyStrings.rhcPillar, image: reportResponse.value.data!.allCarInfo!.rightCpillar?.url),
      if(reportResponse.value.data!.allCarInfo!.runnningBorderLeft != null) Master(title: MyStrings.lhRunBoard, image: reportResponse.value.data!.allCarInfo!.runnningBorderLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.runnningBorderRight != null) Master(title: MyStrings.rhRunBoard, image: reportResponse.value.data!.allCarInfo!.runnningBorderRight?.url),
      if(reportResponse.value.data!.allCarInfo!.tailLightLeft != null) Master(title: MyStrings.tailLightLh, image: reportResponse.value.data!.allCarInfo!.tailLightLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.tailLightRight != null) Master(title: MyStrings.tailLightRh, image: reportResponse.value.data!.allCarInfo!.tailLightRight?.url),
      if(reportResponse.value.data!.allCarInfo!.rearWiper != null) Master(title: MyStrings.rearWiper, image: reportResponse.value.data!.allCarInfo!.rearWiper?.url),
      ...
      if(reportResponse.value.data!.allCarInfo!.bumperRear != null) Master(title: MyStrings.rearBumper, image: reportResponse.value.data!.allCarInfo!.bumperRear?.url),
      ...
      if(reportResponse.value.data!.allCarInfo!.doorFrontLeft != null) Master(title: MyStrings.frontLHDoor, image: reportResponse.value.data!.allCarInfo!.doorFrontLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.doorFrontRight != null) Master(title: MyStrings.frontRHDoor, image: reportResponse.value.data!.allCarInfo!.doorFrontRight?.url),
      if(reportResponse.value.data!.allCarInfo!.doorRearLeft != null) Master(title: MyStrings.rearLHDoor, image: reportResponse.value.data!.allCarInfo!.doorRearLeft?.url),
      if(reportResponse.value.data!.allCarInfo!.doorFrontRight != null) Master(title: MyStrings.rearRHDoor, image: reportResponse.value.data!.allCarInfo!.doorRearRight?.url),
    ];
    interiorImages.value = [
      ...
      if(reportResponse.value.data!.allCarInfo!.carElectrical != null) Master(title: MyStrings.carElectrical, image: reportResponse.value.data!.allCarInfo!.carElectrical?.url),
      if(reportResponse.value.data!.allCarInfo!.cngKitImage != null) Master(title: MyStrings.cngLpgKitImage, image: reportResponse.value.data!.allCarInfo!.cngKitImage?.url),
      if(reportResponse.value.data!.allCarInfo!.platformImage != null) Master(title: MyStrings.platform, image: reportResponse.value.data!.allCarInfo!.platformImage?.url),
    ...
    engineImages.value = [
      ...
      if(reportResponse.value.data!.allCarInfo!.engine != null) Master(title: MyStrings.engine, image: reportResponse.value.data!.allCarInfo!.engine?.url),
      if(reportResponse.value.data!.allCarInfo!.battery != null) Master(title: MyStrings.battery, image: reportResponse.value.data!.allCarInfo!.battery?.url),
      if(reportResponse.value.data!.allCarInfo!.blowBy != null) Master(title: MyStrings.blowByBackCompression, image: reportResponse.value.data!.allCarInfo!.blowBy?.url),
      if(reportResponse.value.data!.allCarInfo!.gearBox != null) Master(title: MyStrings.gearbox, image: reportResponse.value.data!.allCarInfo!.gearBox?.url),
      if(reportResponse.value.data!.allCarInfo!.engineOil != null) Master(title: MyStrings.engineOil, image: reportResponse.value.data!.allCarInfo!.engineOil?.url),
      if(reportResponse.value.data!.allCarInfo!.clutch != null) Master(title: MyStrings.clutchOperations, image: reportResponse.value.data!.allCarInfo!.clutch?.url),
      if(reportResponse.value.data!.allCarInfo!.turboCharger != null) Master(title: MyStrings.turboCharger, image: reportResponse.value.data!.allCarInfo!.turboCharger?.url),
      if(reportResponse.value.data!.allCarInfo!.sump != null) Master(title: MyStrings.sump, image: reportResponse.value.data!.allCarInfo!.sump?.url),
    ];
