...
class sone extends StatelessWidget {
      ...
      body: Column(
        children: [
          Container(
            height: 324,
            width: 327,
            child: SvgPicture.asset('lib/Assets/By my car-rafiki 2.svg')
          ),
          Text('High-quality Certified \n              Cars',style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700,fontStyle: FontStyle.normal,color:Color(0xFF000000) ),),
          SizedBox(height: 10),
          Text('Grow your business ahead with \n          100% certified cars',style: TextStyle(fontSize: 14,fontStyle: FontStyle.normal,fontWeight: FontWeight.w500),),
          SizedBox(height: 10),
          Padding(
