...
class sfour extends StatelessWidget {
  const sfour  ({super.key});
      ...
      body: Column(
        children: [
          Container(
              height: 324,
              width: 327,
              child: SvgPicture.asset('lib/assets/Car finance-cuate 1.svg')
          ),
          Text('Support you \n  can Trust',style: TextStyle(fontSize: 25,fontWeight: FontWeight.w700,fontStyle: FontStyle.normal,color:Color(0xFF000000) ),),
          SizedBox(height: 10),
          Text('Enjoy hassle-free delivery, secure payments, \n          and dedicated customer support',style: TextStyle(fontSize: 14,fontStyle: FontStyle.normal,fontWeight: FontWeight.w500),),
          SizedBox(height: 10),
          Padding(
